...
namespace QuanLyNhaSach
{
    public partial class frmBanHang_TraHang : Form
    {
        ...
        {
            if (txtTheoMaHoaDon.Text == "Theo mã hóa đơn")
            {
                txtTheoMaHoaDon.Text = "";
                txtTheoMaHoaDon.ForeColor = Color.Black;
            }
        }
        ...
        public void reloadDatagridviewDanhSachHoaDon()
        {
            loadDataToDataGridViewHoaDonBanHang();
        }

        private void checkBoxThoiGian_OnChange(object sender, EventArgs e)
        {
